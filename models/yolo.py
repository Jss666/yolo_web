...
class BaseModel(nn.Module):
    ...
    def _profile_one_layer(self, m, x, dt):
        c = isinstance(m, (Detect, Segment)) or isinstance(m, Decoupled_Detect) #解耦头改动@！！！！
    ...
    def _apply(self, fn):
        ...
        if isinstance(m, (Detect, Segment)) or isinstance(m, Decoupled_Detect):
...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in {
                ...
                BottleneckCSP, C3, C3TR, C3SPP, C3Ghost, nn.ConvTranspose2d, DWConvTranspose2d, C3x,BasicBlock,Partial_conv3}:
            c1, c2 = ch[f], args[0]
        ...
        #解耦头改动！！！！！！！！！！！！
        elif m in {Decoupled_Detect,Segment}:
